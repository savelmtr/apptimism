...
from .views import (LoginPage, RegistrationPage, ActivationPage, 
    PasswordChangePage, RegistrationComplete, ActivationComplete,
    PasswordResetPage, PasswordChangeDonePage, PasswordResetDonePage,
    PasswordResetConfirmPage, PasswordResetCompletePage)
